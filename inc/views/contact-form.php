          ...
          <img src="<?php echo IM3_ROOT_URI; ?>img/see-how-you-compare-600x143.jpg" width="600" height="143" alt="See How You Compare" style="width: 100%; height: auto; margin-bottom: 10px;" />
            ...
            <div class="form-group col-sm-6">
              ...
              <input id="FirstName" name="FirstName" class="form-control" type="text" placeholder="First Name" required="required" />
            </div>

            <div class="form-group col-sm-6">
              <label for="LastName">Last Name</label>
              <input id="LastName" name="LastName" class="form-control" type="text" placeholder="Last Name" required="required" />
            </div>
            ...
            <div class="form-group">
              ...
              <input id="Company" name="Company" class="form-control" type="text" placeholder="Company Name" required="required" />
            </div>
