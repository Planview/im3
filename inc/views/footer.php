        ...
        <script type="text/javascript" src="<?php echo IM3_ROOT_URI; ?>js/smartforms.js"></script>
        <script type="text/javascript" src="<?php echo IM3_ROOT_URI; ?>js/tactic-codes.js"></script>
        <script type="text/javascript" src="http://www.manticoretechnology.com/mtcFormAPI.js"></script>
