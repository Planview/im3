            ...
            <figure class="plot-container">
              ...
              <figcaption><b>*</b>Based on finding from the <i>Fourth Product Portfolio Management Benchmark Study</i>. N=730</figcaption>
            </figure>

            <h3><span class="company-name"></span>: Your End Goal for Innovation Management Maturity</h3>
            <p>Based on the answers about <span class="company-name"></span>&rsquo;s end goals for innovation management maturity overall, you rank as shown below along with a comparison to the <i>Fourth Product Portfolio Management Benchmark Study</i> participants.</p>

            <figure class="plot-container">
              <div id="industry-desired" class="plot-inner"></div>
              <figcaption><b>*</b>Based on finding from the <i>Fourth Product Portfolio Management Benchmark Study</i>. N=730</figcaption>
            </figure>
...
<?php   /*
            ...
            <p>The <i>Fourth Product Portfolio Management Benchmark Study</i> uncovers there are very few organizations at the Level 5 stage of maturity today and yet many strive to be a Level 4 or Level 5 as their end goal per the chart below. </p>

            <figure class="plot-container">
              <div id="desired-survey" class="plot-inner"></div>
              <figcaption><b>*</b>Based on finding from the <i>Fourth Product Portfolio Management Benchmark Study</i>. N=730</figcaption>
            </figure>

            <p>For those few that have already achieved Level 5 innovation management maturity, the study uncovered common characteristics across the three categories of people, process, and tools.  Here are some insights into Level 5 maturity which will give you an idea of the depth of the model as well as what to strive for.</p>
...
*/ ?>
            ...
            <h4 style="margin-top: 50px;">Please save this URL to revisit your results later:</h4>
