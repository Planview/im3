...
$new_rc_member_registration = @$_POST["new-rc-member-registration"];
...
//new resource center registration forms use a different name for email address
if (strcasecmp($new_rc_member_registration,"yes") == 0) {
	$EmailAddress = @$_POST["email"];	
}
$captchaHiddenValue = @$_POST["pre-submit-value"];
$captchaEnteredValue = @$_POST["captcha"];
$captchaLength = @$_POST["pre-submit-value-value"];
...
if (strcasecmp($Redirect,"gotomeeting") >= 0) { 
	$questionMarkIndex = strcasecmp($Redirect,"?") + 1;
	$goToMettingURL = substr($Redirect,0,$questionMarkIndex);
	$goToMettingURI = substr($Redirect,$questionMarkIndex);
	$goToMettingURI = rawurlencode($goToMettingURI);
	$goToMettingURI = str_replace("%20","+",$goToMettingURI);
	$goToMettingURI = str_replace("/","%2F",$goToMettingURI);
	$Redirect = $goToMettingURL . $goToMettingURI;
} else {
