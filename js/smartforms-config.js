...
sf$.mLocationTypeFieldAlias="Matched_Location_Type__c";
...
/** socially inferred firmographic data **/
sf$.inferredIndustryFieldAlias="inferredIndustry";
sf$.inferredPublicFieldAlias="inferredPublic";
sf$.inferredRevenueFieldAlias="inferredRevenue";
sf$.inferredEmployeesFieldAlias="inferredEmployees";

/** Required mappings **/
sf$.smartFormID="WEBForm";
sf$.confidenceLevelFieldAlias="Confidence_Level__c";
sf$.confidenceDescFieldAlias="confidenceDescription";
...
sf$.remediateCompanyLevel="review";

/** Translates SIC code to custom Industry name via AltSic **/
